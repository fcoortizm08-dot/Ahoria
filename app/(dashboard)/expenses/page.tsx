      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">
            ...
            {topCategory && <> · Mayor: <span className="text-slate-300 font-medium">{topCategory[0]} ({formatCurrency(topCategory[1])})</span></>}
          </p>
        </div>
      ...
      <div className="bg-[#0d1117] rounded-xl border border-[#1e2d45] overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-slate-500 text-sm">No hay gastos en este mes.</p>
          ...
          <table className="w-full">
                ...
                <tr key={tx.id} className="border-b border-[#1e2d45] last:border-0 hover:bg-white/[0.02]">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm flex-shrink-0" style={{ background: (tx.category?.color ?? '#ef4444') + '20' }}>
                        {tx.category?.icon ?? '↓'}
                      </div>
                      <div>
                  ...
                  <td className="px-4 py-3 text-xs text-slate-400 hidden sm:table-cell">{tx.category?.name ?? '—'}</td>
            ...
            <tfoot>
              <tr className="border-t border-[#1e2d45]">
                ...
                <td className="px-4 py-3 text-sm font-extrabold text-red-400 text-right">{formatCurrency(total)}</td>
                <td />
              </tr>
            </tfoot>
          </table>
